<template>
    <section class="list">
      ...
      <div>
        <button @click="alert(`Consiste em criar resumos cheios de símbolos, cores, setas e frases de efeito com o objetivo de organizar o conteúdo e facilitar associações entre as informações destacadas. <br>
